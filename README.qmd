...
[![R-CMD-check](https://github.com/ggseg/ggsegIca/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ggseg/ggsegIca/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->

This package contains dataset for plotting the ICA atlas with ggseg and ggseg3d.
